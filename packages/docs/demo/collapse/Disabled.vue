...
<template>
    <li-collapse v-model="activeNames">
        ...
        <li-collapse-item title="Feedback" name="2" disabled>
            <div>
        ...
        <li-collapse-item title="Efficiency" name="3" disabled>
            <div>
        ...
        <li-collapse-item name="5">
            <template #title> Controllability5555555555 </template>
            <div>
                Decision making: giving advices about operations is acceptable,
                but do not make decisions for the users;
            </div>
